module IB
  ...
  class ContractDetail < IB::Model
    ...
    prop :market_name, # The market name for this contract.
         ...
         %i[time_zone time_zone_id], # Time zone for the trading hours (e.g. EST)
         ...
         %i[ev_multiplier ev_multipler], # evMultiplier - double, tells you approximately
    ...
    def to_human
      ...
      unless under_con_id.zero?
        ret << "underlying: con_id:#{under_con_id} , sec_type:#{under_sec_type}, symbol:#{under_symbol} "
      end
