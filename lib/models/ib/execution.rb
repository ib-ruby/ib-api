module IB
  ...
  class Execution < IB::Model
    ...
    prop :local_id, #   int: order id. TWS orders have a fixed order id of 0.
         ...
         :model_code,
         :last_liquidity,
         %i[quantity shares], #       int: The number of shares filled.
         ...
         %i[account_name account_number] => :s, # The customer account number.
         %i[side action] => PROPS[:side] # Was the transaction a buy or a sale: BOT|SLD
